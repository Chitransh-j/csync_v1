        ...
        <div className="footer-container">
          ...
          <div className="right">
            ...
            <p>
              ...
              all the clubs. C-sync provides a centralised platform for all
              this. We are the one and only stop for all your PR needs. Find out
              about the upcoming and past events here and ignore those WhatsApp
              forwards.
            </p>
            <br />
            <p>
